            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex justify-center lg:justify-end order-2 lg:order-1">
                <div className="relative group">
                  <div className="w-80 h-80 rounded-full bg-gradient-to-r from-blue-600/20 to-purple-600/20 flex items-center justify-center border-2 border-blue-500/30 group-hover:border-blue-500/50 transition-all duration-300">
                    <div className="w-72 h-72 rounded-full bg-slate-700/50 flex items-center justify-center group-hover:bg-slate-700/70 transition-all duration-300">
                      <div className="text-6xl text-slate-400 group-hover:text-slate-300 transition-colors duration-300">👤</div>
                    </div>
                  </div>
                  ...
                  <div className="absolute bottom-8 left-8 bg-blue-500/20 border border-blue-500/50 rounded-full px-3 py-1 text-blue-400 text-sm font-medium">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  ...
                  <Link to="/certificates">
                    <Button 
                      variant="outline" 
                      size="lg"
                      className="border-purple-500/50 text-purple-400 hover:bg-purple-500/10 px-8 py-3 rounded-full transition-all duration-300 hover:scale-105 transform"
                    >
                  ...
                  <Button 
                    variant="outline" 
                    size="lg"
                    className="border-blue-500/50 text-blue-400 hover:bg-blue-500/10 px-8 py-3 rounded-full transition-all duration-300 hover:scale-105 transform"
                  >
