...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      {/* Stats Section with Awesome Animations */}
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {stats.map((stat, index) => (
              <Card key={index} className="bg-slate-800/50 border-slate-700/50 backdrop-blur-sm hover:bg-slate-800/70 transition-all duration-300 hover:scale-110 hover:-translate-y-2 group overflow-hidden relative">
                ...
                <CardContent className="p-6 text-center relative z-10">
                  <stat.icon className="h-8 w-8 text-blue-400 mx-auto mb-3 group-hover:text-blue-300 group-hover:scale-125 transition-all duration-300" />
                  <div className="text-3xl font-bold text-white mb-1 group-hover:text-blue-100 transition-colors duration-300">{stat.value}</div>
          ...
          <Card className="bg-slate-800/30 border-slate-700/50 backdrop-blur-sm">
            ...
            <CardContent className="p-8">
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  <div className="p-6 bg-gradient-to-r from-blue-600/10 to-purple-600/10 rounded-xl border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300">
                    ...
                    <div className="space-y-3">
                      <Button 
                        className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white hover:scale-105 transform transition-all duration-300"
                        onClick={() => window.open('mailto:tim@voelker-freiburg.de')}
                      >
                      ...
                      <Button 
                        className="w-full bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 text-white hover:scale-105 transform transition-all duration-300"
                        onClick={() => window.open('https://wa.me/qr/CR22CLC3CC7NJ1')}
                      >
